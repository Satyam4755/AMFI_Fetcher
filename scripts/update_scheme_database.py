...
def main():
    print("Starting Full Scheme Update Pipeline...")
    
    # Resolve the base directory
    base_dir = Path(__file__).resolve().parent.parent
    
    # Define script paths
    fetch_script = base_dir / "scripts" / "fetch_scheme_data.py"
    import_script = base_dir / "scripts" / "import_scheme_csv.py"
    ...
    try:
        ...
        print("- Scheme data fetched successfully.")
